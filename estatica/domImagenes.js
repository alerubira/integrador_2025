...
function subirImagen() {
    ...
    idPerfil.value=idPerfilPersonal.idPerfilPersonal;
    idAlbumSeleccionado.value=idAlbumSeleccionado.idAlbumSeleccionado;
...
document.getElementById('formSubirImagenAlbum').addEventListener('submit', async function(e) {
    e.preventDefault();
   aux=await subirImagenConToken('/subirImagenImagen', this);
   if(aux.success){
